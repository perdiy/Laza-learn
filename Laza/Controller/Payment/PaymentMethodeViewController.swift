...
class PaymentMethodeViewController: UIViewController {
    ...
    // Memperbarui gambar tombol centang (checkbox)
    ...
    // Memperbarui status tombol pembayaran berdasarkan pilihan OVO atau Kartu Kredit
